	...
	tests := []testcase[T]{
		{
			...
			test: func(t T) {
				...
				require.NoError(t, cr.GetLatestValue(ctx, types.NewBoundContract("", AnyContractName, MethodTakingLatestParamsReturningTestStruct), params, actual))
		...
		},
		{
			...
			test: func(t T) {
				...
				var prim uint64
				require.NoError(t, cr.GetLatestValue(ctx, types.NewBoundContract("", AnyContractName, MethodReturningUint64), nil, &prim))
		...
		},
		{
			...
			test: func(t T) {
				...
				var prim uint64
				require.NoError(t, cr.GetLatestValue(ctx, types.NewBoundContract("", AnyContractName, DifferentMethodReturningUint64), nil, &prim))
		...
		},
		{
			...
			test: func(t T) {
				...
				var prim uint64
				require.NoError(t, cr.GetLatestValue(ctx, types.NewBoundContract("", AnySecondContractName, MethodReturningUint64), nil, &prim))
		...
		},
		{
			...
			test: func(t T) {
				...
				var slice []uint64
				require.NoError(t, cr.GetLatestValue(ctx, types.NewBoundContract("", AnyContractName, MethodReturningUint64Slice), nil, &slice))
		...
		},
		{
			...
			test: func(t T) {
				...
				require.NoError(t, cr.GetLatestValue(ctx, types.NewBoundContract("", AnyContractName, MethodReturningSeenStruct), testStruct, actual))
		...
		},
		{
			...
			test: func(t T) {
				...
				assert.Eventually(t, func() bool {
					err := cr.GetLatestValue(ctx, types.NewBoundContract("", AnyContractName, EventName), nil, &result)
		...
		},
		{
			...
			test: func(t T) {
				...
				assert.Never(t, func() bool {
					result := &TestStruct{}
					err := cr.GetLatestValue(ctx, types.NewBoundContract("", AnyContractName, EventWithFilterName), filterParams, &result)
	...
	tests := []testcase[T]{
		{
			...
			test: func(t T) {
				...
				logs, err := cr.QueryKey(ctx, types.NewBoundContract("", AnyContractName, ""), query.KeyFilter{Key: EventName}, query.LimitAndSort{}, &TestStruct{})
		...
		},
		{
			...
			test: func(t T) {
				...
				assert.Eventually(t, func() bool {
					...
					sequences, err := cr.QueryKey(ctx, types.NewBoundContract("", AnyContractName, ""), query.KeyFilter{Key: EventName}, query.LimitAndSort{}, ts)
