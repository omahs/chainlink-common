...
var file_chain_reader_proto_rawDesc = []byte{
	...
	0x73, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x22, 0x77, 0x0a, 0x0d, 0x42, 0x6f, 0x75, 0x6e, 0x64,
	0x43, 0x6f, 0x6e, 0x74, 0x72, 0x61, 0x63, 0x74, 0x12, 0x18, 0x0a, 0x07, 0x61, 0x64, 0x64, 0x72,
	0x65, 0x73, 0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x61, 0x64, 0x64, 0x72, 0x65,
	0x73, 0x73, 0x12, 0x1a, 0x0a, 0x08, 0x63, 0x6f, 0x6e, 0x74, 0x72, 0x61, 0x63, 0x74, 0x18, 0x02,
	...
	0x6d, 0x65, 0x74, 0x68, 0x6f, 0x64, 0x12, 0x18, 0x0a, 0x07, 0x70, 0x65, 0x6e, 0x64, 0x69, 0x6e,
	...
	0x02, 0x32, 0xff, 0x01, 0x0a, 0x0b, 0x43, 0x68, 0x61, 0x69, 0x6e, 0x52, 0x65, 0x61, 0x64, 0x65,
	...
	0x55, 0x6e, 0x62, 0x69, 0x6e, 0x64, 0x12, 0x11, 0x2e, 0x6c, 0x6f, 0x6f, 0x70, 0x2e, 0x42, 0x69,
...
var file_chain_reader_proto_depIdxs = []int32{
	13, // 0: loop.GetLatestValueRequest.contract:type_name -> loop.BoundContract
	28, // 1: loop.GetLatestValueRequest.params:type_name -> loop.VersionedBytes
	13, // 2: loop.QueryKeyRequest.contract:type_name -> loop.BoundContract
	14, // 3: loop.QueryKeyRequest.filter:type_name -> loop.QueryKeyFilter
	27, // 4: loop.QueryKeyRequest.limit_and_sort:type_name -> loop.LimitAndSort
	13, // 5: loop.BindRequest.bindings:type_name -> loop.BoundContract
	28, // 6: loop.GetLatestValueReply.ret_val:type_name -> loop.VersionedBytes
	12, // 7: loop.QueryKeyReply.sequences:type_name -> loop.Sequence
	11, // 8: loop.Sequence.head:type_name -> loop.Head
	28, // 9: loop.Sequence.data:type_name -> loop.VersionedBytes
	15, // 10: loop.QueryKeyFilter.expression:type_name -> loop.Expression
	24, // 11: loop.Expression.primitive:type_name -> loop.Primitive
	16, // 12: loop.Expression.boolean_expression:type_name -> loop.BooleanExpression
	1,  // 13: loop.BooleanExpression.boolean_operator:type_name -> loop.BooleanOperator
	15, // 14: loop.BooleanExpression.expression:type_name -> loop.Expression
	15, // 15: loop.And.expr:type_name -> loop.Expression
	15, // 16: loop.Or.expr:type_name -> loop.Expression
	0,  // 17: loop.ValueComparator.operator:type_name -> loop.ComparisonOperator
	19, // 18: loop.Comparator.value_comparators:type_name -> loop.ValueComparator
	0,  // 19: loop.Block.operator:type_name -> loop.ComparisonOperator
	0,  // 20: loop.Timestamp.operator:type_name -> loop.ComparisonOperator
	20, // 21: loop.Primitive.comparator:type_name -> loop.Comparator
	21, // 22: loop.Primitive.block:type_name -> loop.Block
	2,  // 23: loop.Primitive.confidence:type_name -> loop.Confidence
	22, // 24: loop.Primitive.timestamp:type_name -> loop.Timestamp
	23, // 25: loop.Primitive.tx_hash:type_name -> loop.TxHash
	3,  // 26: loop.Limit.direction:type_name -> loop.CursorDirection
	5,  // 27: loop.SortBy.sort_type:type_name -> loop.SortType
	4,  // 28: loop.SortBy.direction:type_name -> loop.SortDirection
	26, // 29: loop.LimitAndSort.sort_by:type_name -> loop.SortBy
	25, // 30: loop.LimitAndSort.limit:type_name -> loop.Limit
	6,  // 31: loop.ChainReader.GetLatestValue:input_type -> loop.GetLatestValueRequest
	7,  // 32: loop.ChainReader.QueryKey:input_type -> loop.QueryKeyRequest
	8,  // 33: loop.ChainReader.Bind:input_type -> loop.BindRequest
	8,  // 34: loop.ChainReader.Unbind:input_type -> loop.BindRequest
	9,  // 35: loop.ChainReader.GetLatestValue:output_type -> loop.GetLatestValueReply
	10, // 36: loop.ChainReader.QueryKey:output_type -> loop.QueryKeyReply
	29, // 37: loop.ChainReader.Bind:output_type -> google.protobuf.Empty
	29, // 38: loop.ChainReader.Unbind:output_type -> google.protobuf.Empty
